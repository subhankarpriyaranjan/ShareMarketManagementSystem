...
<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		&nbsp;&nbsp;&nbsp;<h1><U><font size=6 color="brown">APPROVE OR REJECT BROKER</font></i></U></h1>&nbsp;&nbsp;&nbsp;
		<center>
		<table border="2">
	<tr>
		...
		<td><s:property value="dmateid"/></td>
		<td><s:property value="email"/></td>
		<td><s:property value="acno"/></td>
		
		<td>
		<s:url id="approvedURL" action="approvebroker">
		<s:param name="id" value="%{loginid}"></s:param>
		</s:url>
		<s:a href="%{approvedURL}">Approvebroker</s:a>
		</td>
		 
		<td>
		<s:url id="rejectURL" action="rejectbroker">
		<s:param name="id" value="%{loginid}"></s:param>
		</s:url>
		<s:a href="%{rejectURL}">Rejectbroker</s:a>
		</td>
