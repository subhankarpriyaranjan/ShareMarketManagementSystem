...
<div id="wrapper">
		...
		<div id="header">
			...
			<div id="menu">
				<ul>
					...
					<a href="homepage.jsp" accesskey="1" title="">Homepage</a></li>
	...
	<div id="page-wrapper">
		...
		<h1><U><font size=6 color="brown">COMPANY  HOME PAGE</font></U></h1>&nbsp;&nbsp;&nbsp;&nbsp;
	
		<li><a href="entershare"><font size=5 color="blue">ENTER  COMPANY SHARE </font></a></li>&nbsp;
		<ul type="square" color="blue">
		<li><a href="editcomp"><font size=5 color="blue"> EDIT COMPANY</font></a></li>&nbsp;
		<li><a href="editshare"><font size=5 color="blue">EDIT SHARE</font></a></li>&nbsp;
		<li><a href="detailsoffeedback.jsp"><font size=5 color="blue">FEEDBACK</font></a></li>
		<li><a href="login.jsp"><font size=5 color="blue">LOGOUT</font></a></li>&nbsp;
		</ul>
