...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div id="page">
	    <a href="customermngt.jsp"><font size="3" color="blue">Back</font></a></br>&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;<h1><U><font size=6 color="brown">APPROVE OR REJECT CUSTOMER</font></U></h1>&nbsp;&nbsp;&nbsp;
		<table>
		<s:form action="apprejcust">
		<tr><td>
