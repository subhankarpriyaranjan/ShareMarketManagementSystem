...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div id="page">
	    <a href="brokermngt.jsp"><font size="3" color="blue">Back</font></a></br>&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;<h1><U><font size=6 color="brown">APPROVE OR REJECT BROKER</font></U></h1>&nbsp;&nbsp;&nbsp;
		<table>
		<s:form action="apprejbroker">
		<tr><td>
		<s:select label="CHOOSE BROKER" name="loginid" headerKey="-1" list="MapForSelect" headerValue="---please select---" >
		</s:select></td></tr>
