...
<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<table>
		<s:form action="confpsw">
		<tr><td><s:property value="usertype"/>
		</td></tr>
		<tr><td><s:textfield name="username" label="USERNAME"></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="usertype" label="USERTYPE"></s:textfield>
		</td></tr>
		<tr><td><s:password name="npassword" label="NEW PASSWORD"></s:password>
		</td></tr>
		<tr><td><s:password name="rpassword" label="RETYPE PASSWORD"></s:password>
		</td></tr>
		<tr><td colspan="2" align="right" > <s:submit value="CONFIRM" ></s:submit>
		</td></tr>
		</s:form>
