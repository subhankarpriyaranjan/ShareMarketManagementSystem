...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div id="page">
		<h1><U><font size="6" color="brown">COMPANY MANAGEMENT</font></U></h1>
	
		<s:form action="compmngt" >
		<ul type="square">
		<li><a href="home.jsp">HOME</a></li>&nbsp;
		<li><a href="combo1">APPROVE/REJECT COMPANY</a></li>&nbsp;
		<li><a href="combo2">DELETE COMPANY</a></li></ul>
		</s:form>
		</div>
		</div>
	</div>
