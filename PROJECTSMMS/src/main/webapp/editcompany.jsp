...
<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<center><h1><U><font size="6" color="brown">COMPANY DETAILS</font></U></h1></center>
		<center>
		<table>
		<s:form action="editcomp1">
		<s:hidden name="loginid"></s:hidden>
		<tr><td><s:textfield name="companyname" label="COMPANY NAME" />
		</td></tr>
		<tr><td ><s:textarea name="address" label="ADDRESS" ></s:textarea>
		</td></tr>
		<tr><td><s:textfield name="city" label="CITY"  ></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="state" label="STATE"></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="officeno" label="OFFICE NO." ></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="faxno" label="FAX NO." ></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="website" label="WEBSITE" ></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="email" label="EMAIL ID" ></s:textfield>
		</td></tr>
		<!----<tr><td><s:textfield name="shareamount" label="SHARE AMOUNT"></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="noofshare" label="NO.OF SHARE"></s:textfield>
		</td></tr>!-->
		<tr><td colspan="2" align="right" > <s:submit value="UPDATE" ></s:submit>
		</td></tr>
		</s:form>
		</table>
