...
<div id="wrapper">
	...
	<div id="page-wrapper">
		...
		<table>
          ...
          <tr><td><s:textfield name="noofshare" label="No of shares Having" readonly="true"></s:textfield></td></tr>
          ...
          <tr><td><s:textfield name="amtdeposited" label="Amount deposited" readonly="true"></s:textfield></td></tr>
