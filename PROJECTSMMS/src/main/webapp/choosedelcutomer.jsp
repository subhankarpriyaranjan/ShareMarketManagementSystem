...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div id="page">
	    <a href="companymngt.jsp"><font size="3" color="blue">Back</font></a></br>&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;<h1><U><font size=6 color="green" font=>COMPANY WHICH DELETED</font></i></U></h1>&nbsp;&nbsp;&nbsp;
		<table>
		<s:form action="deletcustomer">
		<tr><td>
		<s:select label="CHOOSE CUSTOMER" name="loginid" headerKey="-1" list="MapForSelect" headerValue="---please select---" >
		</s:select></td></tr>
