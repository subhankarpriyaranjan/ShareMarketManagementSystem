...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div id="page">
		<h1><U><font size=6 color="brown">TRANSACTION</font></U></h1>&nbsp;&nbsp;&nbsp;&nbsp;
	
		<s:form action="loginaction" >
		<ul type="square" color="blue">
		<li><a href="home.jsp"><font size=5 color="blue">HOME</font></a></li><br/>&nbsp;&nbsp;&nbsp;&nbsp;
		<li><a href="sale"><font size=5 color="blue">SALE</font></a></li><br/>&nbsp;&nbsp;&nbsp;&nbsp;
		<li><a href="purchase"><font size=5 color="blue">PURCHASE</font></a></li><br/>&nbsp;
		</ul>
		</s:form>
		</div>
		</div>
