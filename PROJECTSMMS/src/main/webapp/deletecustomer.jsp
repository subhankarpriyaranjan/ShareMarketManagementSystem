...
<div id="wrapper">
		...
		<div id="header">
			...
			<div id="menu">
				<ul>
					...
					<li><a href="loghin.jsp" accesskey="2" title="">Login</a></li>
	...
	<div id="page-wrapper">
		<div id="page">
		<h1><U><i>CUSTOMER DETAILS</i></U></h1>
		<table>
		<s:form action="deletecustomerrec">
		<s:hidden name="loginid"></s:hidden>
		<tr><td><s:textfield name="firstname" label="FIRST NAME" readonly="true"></s:textfield>
		</td></tr>
		...
		<tr><td><s:textfield name="dateofbirth" label="DATE OF BIRTH"></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="pincode" label="PINCODE"></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="email" label="EMAIL ID"></s:textfield>
		</td></tr>
		<tr><td><s:textfield name="phon" label="PHONE NO."></s:textfield>
		</td></tr>
		<tr><td><s:submit value="delete"/></td></tr>
		</s:form>
