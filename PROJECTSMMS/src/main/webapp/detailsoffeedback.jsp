...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div id="page">
		<h1><U><i>PLZ GIVE UR FEEDBACK</i></U></h1>
		<table>
		<s:form action="feedbackcomp" >
	<tr><td><s:textarea name="subject" label="ENTER UOR SUBJECT "></s:textarea>
		</td></tr>
		
		<tr><td><s:textarea name="enterurcomment" label="GIVE UR COMMENT HERE "></s:textarea>
		</td></tr>
		
		<tr><td><sx:datetimepicker name="dateofpost" label="Format (dd-MMM-yyyy)" displayFormat="dd-MMM-yyyy" value="todayDate" />
